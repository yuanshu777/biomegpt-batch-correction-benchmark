...
method_id <- "grl_abundance_l8_lam10_cw01_rw1"
...
matrices <- list(
  ...
  `Old GRL cw0.1` = read_abundance_csv(
...
study_path <- file.path(output_dir, "raw_mmuphin_old_cw01_pca_by_study_panel.png")
condition_path <- file.path(
  output_dir,
  "raw_mmuphin_old_cw01_pca_by_condition_panel.png"
)
score_path <- file.path(output_dir, "raw_mmuphin_old_cw01_pca_scores.csv")
